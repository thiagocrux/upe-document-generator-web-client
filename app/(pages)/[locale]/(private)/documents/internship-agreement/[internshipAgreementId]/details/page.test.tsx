...
import InternshipAgreementDetailsPage from './page';

describe('InternshipAgreementDetailsPage', () => {
  it('renders a paragraph with the title of the page', async () => {
    render(
      <NextIntlClientProvider locale="pt-BR" messages={ptBRMessages}>
        <InternshipAgreementDetailsPage />
    ...
    expect(t(paragraph.textContent.trim())).toBe(
      ptBRMessages.pages.internal.InternshipAgreementDetailsPage.metadata.title
    );
  });
});
