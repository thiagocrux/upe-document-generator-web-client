...
describe('InternshipAgreementFormPage', () => {
  it('renders a paragraph with the title of the page', async () => {
    ...
    expect(t(paragraph.textContent.trim())).toBe(
      ptBRMessages.pages.internal.InternshipAgreementFormPage.metadata.title
    );
  });
});
