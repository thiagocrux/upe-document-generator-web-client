...
import InternshipSupervisionStatementFormPage from './page';

describe('InternshipSupervisionStatementFormPage', () => {
  it('renders a paragraph with the title of the page', async () => {
    render(
      <NextIntlClientProvider locale="pt-BR" messages={ptBRMessages}>
        <InternshipSupervisionStatementFormPage />
    ...
    expect(t(paragraph.textContent.trim())).toBe(
      ptBRMessages.pages.internal.InternshipSupervisionStatementFormPage
        .metadata.title
    );
  });
});
