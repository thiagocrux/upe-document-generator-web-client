...
import InternshipReferralDetailsPage from './page';

describe('InternshipReferralDetailsPage', () => {
  it('renders a paragraph with the title of the page', async () => {
    render(
      <NextIntlClientProvider locale="pt-BR" messages={ptBRMessages}>
        <InternshipReferralDetailsPage />
    ...
    expect(t(paragraph.textContent.trim())).toBe(
      ptBRMessages.pages.internal.InternshipReferralDetailsPage.metadata.title
    );
  });
});
